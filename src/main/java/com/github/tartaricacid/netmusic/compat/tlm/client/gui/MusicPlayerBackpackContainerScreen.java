...
public class MusicPlayerBackpackContainerScreen extends AbstractMaidContainerGui<MusicPlayerBackpackContainer> implements IBackpackContainerScreen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(this.leftPos + 142, this.topPos + 135, 15, 20,
                new TextComponent("<"), b -> clickButton(0),
                (button, poseStack, mouseX, mouseY) -> renderTooltip(poseStack, new TranslatableComponent("gui.netmusic.maid.music_player_backpack.previous"), mouseX, mouseY)));

        this.addRenderableWidget(new Button(this.leftPos + 235, this.topPos + 135, 15, 20,
                new TextComponent(">"), b -> clickButton(1),
                (button, poseStack, mouseX, mouseY) -> renderTooltip(poseStack, new TranslatableComponent("gui.netmusic.maid.music_player_backpack.next"), mouseX, mouseY)));

        this.addRenderableWidget(new Button(this.leftPos + 159, this.topPos + 135, 36, 20,
                new TranslatableComponent("gui.netmusic.maid.music_player_backpack.stop"), b -> this.clickButton(2)));

        this.addRenderableWidget(new Button(this.leftPos + 197, this.topPos + 135, 36, 20,
                new TranslatableComponent("gui.netmusic.maid.music_player_backpack.play"), b -> this.clickButton(3)));
    }
